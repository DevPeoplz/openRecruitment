...
> = {
  ...
  EventScheduleInterviewer: {
    ...
    queries: {
      findFirst:
        EventScheduleInterviewer.findFirstEventScheduleInterviewerQueryObject,
      findMany:
        EventScheduleInterviewer.findManyEventScheduleInterviewerQueryObject,
      count: EventScheduleInterviewer.countEventScheduleInterviewerQueryObject,
      findUnique:
        EventScheduleInterviewer.findUniqueEventScheduleInterviewerQueryObject,
    },
    mutations: {
      createMany:
        EventScheduleInterviewer.createManyEventScheduleInterviewerMutationObject,
      createOne:
        EventScheduleInterviewer.createOneEventScheduleInterviewerMutationObject,
      deleteMany:
        EventScheduleInterviewer.deleteManyEventScheduleInterviewerMutationObject,
      deleteOne:
        EventScheduleInterviewer.deleteOneEventScheduleInterviewerMutationObject,
      updateMany:
        EventScheduleInterviewer.updateManyEventScheduleInterviewerMutationObject,
      updateOne:
        EventScheduleInterviewer.updateOneEventScheduleInterviewerMutationObject,
      upsertOne:
        EventScheduleInterviewer.upsertOneEventScheduleInterviewerMutationObject,
    },
  },
  EventScheduleEvaluation: {
    ...
    queries: {
      findFirst:
        EventScheduleEvaluation.findFirstEventScheduleEvaluationQueryObject,
      findMany:
        EventScheduleEvaluation.findManyEventScheduleEvaluationQueryObject,
      count: EventScheduleEvaluation.countEventScheduleEvaluationQueryObject,
      findUnique:
        EventScheduleEvaluation.findUniqueEventScheduleEvaluationQueryObject,
    },
    mutations: {
      createMany:
        EventScheduleEvaluation.createManyEventScheduleEvaluationMutationObject,
      createOne:
        EventScheduleEvaluation.createOneEventScheduleEvaluationMutationObject,
      deleteMany:
        EventScheduleEvaluation.deleteManyEventScheduleEvaluationMutationObject,
      deleteOne:
        EventScheduleEvaluation.deleteOneEventScheduleEvaluationMutationObject,
      updateMany:
        EventScheduleEvaluation.updateManyEventScheduleEvaluationMutationObject,
      updateOne:
        EventScheduleEvaluation.updateOneEventScheduleEvaluationMutationObject,
      upsertOne:
        EventScheduleEvaluation.upsertOneEventScheduleEvaluationMutationObject,
    },
  },
  Event: {
  ...
  CandidateCustomFields: {
    ...
    queries: {
      findFirst:
        CandidateCustomFields.findFirstCandidateCustomFieldsQueryObject,
      ...
      findUnique:
        CandidateCustomFields.findUniqueCandidateCustomFieldsQueryObject,
    },
    mutations: {
      createMany:
        CandidateCustomFields.createManyCandidateCustomFieldsMutationObject,
      createOne:
        CandidateCustomFields.createOneCandidateCustomFieldsMutationObject,
      deleteMany:
        CandidateCustomFields.deleteManyCandidateCustomFieldsMutationObject,
      deleteOne:
        CandidateCustomFields.deleteOneCandidateCustomFieldsMutationObject,
      updateMany:
        CandidateCustomFields.updateManyCandidateCustomFieldsMutationObject,
      updateOne:
        CandidateCustomFields.updateOneCandidateCustomFieldsMutationObject,
      upsertOne:
        CandidateCustomFields.upsertOneCandidateCustomFieldsMutationObject,
    },
  },
  Evaluation: {
  ...
  SharedCandidateLink: {
    ...
    mutations: {
      createMany:
        SharedCandidateLink.createManySharedCandidateLinkMutationObject,
      createOne: SharedCandidateLink.createOneSharedCandidateLinkMutationObject,
      deleteMany:
        SharedCandidateLink.deleteManySharedCandidateLinkMutationObject,
      deleteOne: SharedCandidateLink.deleteOneSharedCandidateLinkMutationObject,
      updateMany:
        SharedCandidateLink.updateManySharedCandidateLinkMutationObject,
