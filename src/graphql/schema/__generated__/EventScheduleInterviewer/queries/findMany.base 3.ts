...
export const findManyEventScheduleInterviewerQueryObject = defineQueryFunction(
  (t) =>
    defineQueryPrismaObject({
...
export const findManyEventScheduleInterviewerQuery = defineQuery((t) => ({
  findManyEventScheduleInterviewer: t.prismaField(
    findManyEventScheduleInterviewerQueryObject(t)
  ),
}))
