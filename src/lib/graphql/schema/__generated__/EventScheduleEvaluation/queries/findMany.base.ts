...
export const findManyEventScheduleEvaluationQueryArgs = builder.args((t) => ({
...
export const findManyEventScheduleEvaluationQueryObject = defineQueryFunction((t) =>
  defineQueryPrismaObject({
    type: ['EventScheduleEvaluation'],
    nullable: false,
    args: findManyEventScheduleEvaluationQueryArgs,
...
export const findManyEventScheduleEvaluationQuery = defineQuery((t) => ({
  findManyEventScheduleEvaluation: t.prismaField(findManyEventScheduleEvaluationQueryObject(t)),
}));
