...
export const findManyAttachmentQueryArgs = builder.args((t) => ({
...
export const findManyAttachmentQueryObject = defineQueryFunction((t) =>
  defineQueryPrismaObject({
    type: ['Attachment'],
    nullable: false,
    args: findManyAttachmentQueryArgs,
...
export const findManyAttachmentQuery = defineQuery((t) => ({
  findManyAttachment: t.prismaField(findManyAttachmentQueryObject(t)),
}));
