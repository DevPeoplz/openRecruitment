...
export const updateManyOfferTagMutationArgs = builder.args((t) => ({
      where: t.field({ type: Inputs.OfferTagWhereInput, required: false }),
      data: t.field({ type: Inputs.OfferTagUpdateManyMutationInput, required: true }),
    }))
...
export const updateManyOfferTagMutationObject = defineMutationFunction((t) =>
  defineMutationObject({
    type: BatchPayload,
    nullable: false,
    args: updateManyOfferTagMutationArgs,
